  ...
  protected readonly projects: ProjectItem[] = [
    {
      ...
      description: 'Aplicação da técnica Pomodoro com controle de ciclos, histórico de sessões e navegação SPA para uso diário de foco.',
      technologies: ['React 19', 'TypeScript', 'Vite 7', 'React Router 7', 'date-fns', 'Lucide React'],
    ...
    },
    {
      ...
      description: 'Frontend moderno com navegação fluida, transições de página e experiência responsiva baseada em stack React/Next atual.',
      technologies: ['Next.js 16', 'React 19', 'TypeScript', 'MUI 7', 'Tailwind CSS 4', 'Framer Motion', 'Swup'],
    ...
    },
    {
      ...
      description: 'Loja online com catálogo de 500+ produtos, carrinho, avaliações e fluxo de compra orientado a conversão.',
      technologies: ['Next.js 15', 'React 19', 'TypeScript', 'PostgreSQL', 'Drizzle ORM', 'Tailwind CSS', 'Shadcn/ui', 'Auth.js'],
    ...
    },
    {
      ...
      description: 'Website institucional para escritório jurídico com blog, painel administrativo e integração de temas dark/light.',
      technologies: ['Next.js 16', 'React 19', 'TypeScript', 'NestJS', 'Tailwind CSS 4', 'Turbopack', 'SSG'],
      image: '/navarro.png',
    ...
    },
    {
      ...
      description: 'Website institucional com catálogo, integração com WhatsApp e painel administrativo para gestão de produtos e categorias.',
      technologies: ['Next.js 16', 'React 19', 'TypeScript', 'Tailwind CSS 4', 'Framer Motion', 'Turbopack'],
    ...
    },
    {
      ...
      description: 'Sistema para academias com controle de alunos, check-ins, gestão financeira e dashboards por perfil de usuário.',
      technologies: ['Next.js 15', 'React 19', 'TypeScript', 'PostgreSQL', 'Drizzle ORM', 'Tailwind CSS', 'JWT', 'Shadcn/ui'],
